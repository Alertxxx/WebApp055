                ...
                <?php
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr><td>".$row["mid"]."</td>"."<td>".$row["mname"]." ".$row["mlastname"]."</td>"."<td>".$row["maddress"]."</td>"."<td>".$row["mtelephone"]."</td>"."<td>"."<a class='btn btn-warning' href='editbio.php?mid=".$row["mid"]."'>Edit</a>"."</td>";
                            echo "</tr>";    
                        }
                    }else {
                        echo "0 results";
